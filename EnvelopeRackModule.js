...
export default class EnvelopeRackModule extends RackModule {
    ...
    triggerOn() {
        this.envelope.gain.setValueAtTime(0, this.audioContext.currentTime);
        this.envelope.gain.linearRampToValueAtTime(1, this.audioContext.currentTime + this.a);
        this.envelope.gain.linearRampToValueAtTime(this.s, this.audioContext.currentTime + this.a + this.d);
    }
    triggerOff() {
        this.envelope.gain.setValueAtTime(this.s, this.audioContext.currentTime);
        this.envelope.gain.linearRampToValueAtTime(0, this.audioContext.currentTime + this.r);
    }
